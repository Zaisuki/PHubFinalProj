      ...
      try {
        ...
        setSubjects(() =>
          response.userType === "student"
            ? response.userDetails.studentSubjects[0].class
            : response.userDetails.professorHandledClass[0].class
        );
      } catch (error) {
          ...
          subjects.map((subject) => (
            ...
            >
              ...
              <Card.Body className="body">
                ...
                <button
                  onClick={() => navigate(`/course-new/${subject._id}`)}
                  type="button"
                  className="btn btn-dark btn-student"
