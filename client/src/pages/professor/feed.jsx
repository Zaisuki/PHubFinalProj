            ...
            announcements.map((announcement) => (
              <Card className="feed-announcement" key={announcement._id}>
                ...
                <div className="header-announcement">
                  ...
                  <h1
                    className={`ann ${isTitleBold ? "bold" : ""} ${
                      isTitleItalic ? "italic" : ""
                    } ${isTitleUnderline ? "underline" : ""}`}
                  >
                    {announcement.header}
                  </h1>
                ...
                <hr />
                <p
                  className={`${isDescriptionBold ? "bold" : ""} ${
                    isDescriptionItalic ? "italic" : ""
                  } ${isDescriptionUnderline ? "underline" : ""}`}
                >
                ...
                <div className="h2-text">
                  ...
                  <div className="effects">
                    <MdOutlineFormatItalic
                      className={`i ${isTitleItalic ? "active" : ""}`}
                      onClick={toggleTitleItalic}
                    />
                    <FaBold
                      className={`i ${isTitleBold ? "active" : ""}`}
                      onClick={toggleTitleBold}
                    />
                    <FaUnderline
                      className={`i ${isTitleUnderline ? "active" : ""}`}
                ...
                <div className="h2-text-one">
                  ...
                  <textarea
                    ...
                    style={{
                      fontWeight: isDescriptionBold ? "bold" : "normal",
                      fontStyle: isDescriptionItalic ? "italic" : "normal",
                      textDecoration: isDescriptionUnderline
                        ? "underline"
                        : "none",
                    }}
                  ...
                  <div className="effects">
                    <MdOutlineFormatItalic
                      className={`i ${isDescriptionItalic ? "active" : ""}`}
                      onClick={toggleDescriptionItalic}
                    />
                    <FaBold
                      className={`i ${isDescriptionBold ? "active" : ""}`}
                      onClick={toggleDescriptionBold}
                    />
                    <FaUnderline
                      className={`i ${isDescriptionUnderline ? "active" : ""}`}
                      onClick={toggleDescriptionUnderline}
                    />
                  </div>
                </div>
                <Button
