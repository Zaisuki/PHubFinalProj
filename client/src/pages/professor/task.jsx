                                    ...
                                    {taskSelection === 'Check' ? (
                                        <InputGroup className='plus-title-check'>
                                            <div className='task-name-container-check'>
                                                ...
                                                <textarea className='input-placeholder-check p-2 bg-neutral-700 active active:outline-none focus:outline-none' value={titleValue} placeholder='Write here...' onChange={(e) => setTitleValue(e.target.value)} rows='1' ref={titleTextAreaRef} />
                                            </div>
                                        ...
                                        <InputGroup className='plus-title-connect'>
                                            <div className='task-name-container-connect'>
                                                <h1 className='task-name'>Task Name</h1>
                                                <textarea className='input-placeholder-connect p-2 bg-neutral-700 active active:outline-none focus:outline-none' value={titleValue} placeholder='Write here...' onChange={(e) => setTitleValue(e.target.value)} rows='1' ref={titleTextAreaRef} />
                                            </div>
                                            <div className='h2-text-one'>
                                        ...
                                        <InputGroup className='plus-title-coach'>
                                            <div className='task-name-container-coach'>
                                                <h1 className='task-name'>Task Name</h1>
                                                <textarea className='input-placeholder-coach p-2 bg-neutral-700 active active:outline-none focus:outline-none' value={titleValue} placeholder='Write here...' onChange={(e) => setTitleValue(e.target.value)} rows='1' ref={titleTextAreaRef} />
                                            </div>
                                            <div className='h2-text-one'>
                                                <h2 className='description'>Description</h2>
                                                <textarea className='input-placeholder-coach p-2 bg-neutral-700 active active:outline-none focus:outline-none' value={descriptionValue} placeholder='Write here...' onChange={(e) => setDescriptionValue(e.target.value)} rows='1' ref={descriptionTextAreaRef} />
                                            </div>
                                            <div className='attachment'>
                                                <h1 className='upload'>Upload attachment</h1>
